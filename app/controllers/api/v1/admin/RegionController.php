...
class RegionController extends BaseController {
    ...
    public function index() {
        if ($permissions = $this->checkPermission('admin.region.index')) {
            return $permissions;
        }
    ...
    public function store() {
        if ($permissions = $this->checkPermission('admin.region.store')) {
            return $permissions;
        }
    ...
    public function show($id) {
        if ($permissions = $this->checkPermission('admin.region.show')) {
            return $permissions;
        }
    ...
    public function update($id) {
        if ($permissions = $this->checkPermission('admin.region.update')) {
            return $permissions;
        }
    }

    public function destroy($id) {
        if ($permissions = $this->checkPermission('admin.region.destroy')) {
            return $permissions;
        }
    }
}
